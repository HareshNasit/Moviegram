...
class NewsFeedScreen extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {searched: "",
                  reviews: [{ id: 0, username: "Bhavya" , movieName: "Avengers" , profImg: profileimgdef,
                             ...
                             commentsSection: [{datetime:"", username:"Hassan", commentContent:"Yess!!!!!"}] },
                             { id: 1, username: "Harsh" , movieName: "Messi Rocks" , profImg: profileimgdef,
                             ...
                             { id: 2, username: "Dhruv" , movieName: "Dangal" , profImg: profileimgdef,
                               reviewContent: "Ab toh dangal hoga dangal bhenchooodddddd !!!!!!" ,
                               commentsSection: [] },
                             { id: 3, username: "Yosef" , movieName: "Stalingrad" , profImg: profileimgdef,
